...
const Navbar = () => {
    ...
    return (
        <div className="navbar container mx-auto relative z-50">
            <div className="navbar-start text-[#838383]">
                ...
                <a className="btn btn-ghost text-xl text-white"><img className="w-7 h-7" src={mainLogo} alt="" /> <span className="text-[#71b100]"> Elite Residences</span> Hub</a>
            </div>
